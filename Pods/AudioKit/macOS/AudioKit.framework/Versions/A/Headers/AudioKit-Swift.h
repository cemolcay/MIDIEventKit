...
///
- (nonnull instancetype)init:(AKNode * _Nullable)input ratio:(double)ratio threshold:(double)threshold attackTime:(double)attackTime releaseTime:(double)releaseTime rage:(double)rage rageIsOn:(BOOL)rageIsOn OBJC_DESIGNATED_INITIALIZER;
/// Function to start, play, or activate the node, all do the same thing
- (void)start;
/// Function to stop or bypass the node, both are equivalent
- (void)stop;
...
///
- (nonnull instancetype)initWithFile:(AKAudioFile * _Nullable)file startPoint:(uint32_t)startPoint endPoint:(uint32_t)endPoint rate:(double)rate volume:(double)volume maximumSamples:(NSInteger)maximumSamples completionHandler:(void (^ _Nonnull)(void))completionHandler OBJC_DESIGNATED_INITIALIZER;
/// Function to start, play, or activate the node, all do the same thing
- (void)start;
/// Function to stop or bypass the node, both are equivalent
- (void)stop;
...
+ (void)setEngine:(AVAudioEngine * _Nonnull)value;
